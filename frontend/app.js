...
const REALISTIC_FOOD_IMAGE_RULES = [
  ...
  { keywords: ["蛋挞", "葡式蛋挞", "肯德基 葡式蛋挞", "可颂", "瑞士卷", "泡芙", "提拉米苏", "奶油蛋糕", "芝士蛋糕", "豆沙面包", "奶黄面包", "肉松面包", "全家 香葱肉松面包", "罗森 巧克力可颂", "罗森 抹茶蛋糕卷"], key: "egg" },
  { keywords: ["馒头", "包子", "花卷", "豆沙包", "奶黄包", "叉烧包", "鲜肉包", "菜包"], key: "egg" },
  { keywords: ["小米粥", "八宝粥", "南瓜粥", "白粥", "糍饭团", "寿司饭", "蛋炒饭", "扬州炒饭", "炒饭 夜宵版"], key: "rice" },
  { keywords: ["馄饨", "鲜肉小馄饨", "馄饨面", "牛肉面", "兰州牛肉面", "阳春面", "炸酱面", "热干面", "担担面", "重庆小面", "螺蛳粉", "酸辣粉"], key: "noodle" },
  { keywords: ["烧鹅", "叉烧", "烧鸭", "蜜汁叉烧饭", "烧鸭饭", "东坡肉", "梅干菜烧肉", "红烧狮子头", "腌笃鲜", "糖醋小排"], key: "beef" },
  { keywords: ["猪肉炖粉条", "东北乱炖", "溜肉段", "杀猪菜", "排骨炖豆角", "酸菜白肉", "小炒肉", "辣椒炒肉", "农家一碗香"], key: "beef" },
  { keywords: ["毛血旺", "麻辣香锅", "麻辣香锅 双人份", "火锅羊肉卷", "午餐肉"], key: "beef" },
  { keywords: ["老厨白菜", "东北大拉皮", "尖椒干豆腐", "拔丝地瓜", "烤茄子", "烤韭菜", "烤金针菇", "烤玉米"], key: "vegetable" },
  { keywords: ["娃娃菜", "圣女果", "哈密瓜", "柚子", "沙糖橘", "青提", "红提"], key: "vegetable" },
  { keywords: ["油爆虾", "龙井虾仁", "西湖醋鱼", "松鼠桂鱼", "清炒虾仁", "响油鳝糊", "雪菜黄鱼"], key: "seafood" },
  { keywords: ["虾饺", "生蚝", "烤鱿鱼", "蟹柳"], key: "seafood" },
  { keywords: ["肠粉", "桂林米粉", "柳州螺蛳粉", "肥肠粉", "排骨米线", "过桥米线", "牛肉河粉", "干炒牛河", "炒米粉", "炒河粉 夜宵版", "扬州炒面", "云吞面", "鸭血粉丝汤"], key: "noodle" },
  { keywords: ["艇仔粥", "宽粉", "魔芋丝"], key: "noodle" },
  { keywords: ["7-11 海苔肉松饭团", "盒马 三文鱼寿司"], key: "rice" },
  { keywords: ["7-11 全麦鸡胸三明治", "山姆 烤鸡", "山姆 凯撒鸡肉沙拉", "盒马 鸡胸肉沙拉"], key: "chicken" },
  { keywords: ["7-11 金枪鱼饭团", "全家 烤鸡胸饭团", "全家 溏心蛋饭团", "罗森 金枪鱼饭团", "罗森 海苔肉松饭团", "7-11 照烧鸡腿便当", "7-11 黑椒牛肉便当", "全家 黑椒牛肉便当", "罗森 日式照烧鸡腿便当"], key: "rice" },
  { keywords: ["7-11 即食鸡胸肉", "全家 沙拉鸡胸肉", "全家 低糖鸡胸肉沙拉", "罗森 沙拉鸡胸肉", "罗森 鸡胸肉沙拉", "全家 鸡肉卷", "全家 奥尔良鸡肉卷"], key: "chicken" },
  { keywords: ["7-11 全麦火腿蛋三明治", "7-11 厚切火腿三明治", "全家 金枪鱼三明治", "罗森 全麦鸡蛋三明治", "罗森 火腿鸡蛋三明治"], key: "egg" },
  { keywords: ["7-11 低糖豆浆", "罗森 无糖豆浆", "7-11 关东煮鱼豆腐", "全家 关东煮鱼豆腐", "罗森 关东煮鱼豆腐"], key: "tofu" },
  { keywords: ["全家 关东煮萝卜", "7-11 关东煮海带结", "7-11 关东煮魔芋结", "罗森 关东煮海带结", "罗森 关东煮魔芋结"], key: "vegetable" },
